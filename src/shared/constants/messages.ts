...
export const OTP_MESSAGES = {
  WELCOME_OTP: (otp: string) =>
    `Votre code de vérification KDM est : *${otp}*. Ce code expirera dans 30 minutes.`,
  ...
  OTP_RETRY: (minutes: number) =>
    `Veuillez patienter ${minutes} minute(s) avant de demander un nouveau code.`,
